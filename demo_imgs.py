...
def demo(args):
    ...
    with torch.no_grad():
        ...
        for (imfile1, imfile2) in tqdm(list(zip(left_images, right_images))):
            ...
            filename = os.path.join(output_directory, file_stem.split(".")[0]+"_depth.png" )
            # print("imfile1 ->{}".format(imfile1))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default="./demo_output", help='save result path')
